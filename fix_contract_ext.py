...
class fix_Contract(QMainWindow, Ui_MainWindow, addInfo_Contract):
    ...
    def load_combobox(self):
        self.cbo_trangthai_2.addItems(["Đang chờ hiệu lực", "Có hiệu lực", "Hết hiệu lực", "Đã huỷ", "Sắp hết hạn"])
        self.cbo_trangthai_3.addItems(["Đang chờ hiệu lực", "Có hiệu lực", "Hết hiệu lực", "Đã huỷ", "Sắp hết hạn"])
